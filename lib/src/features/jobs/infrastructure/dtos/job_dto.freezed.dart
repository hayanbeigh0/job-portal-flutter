...
@override
String toString() {
  return 'JobDto(id: $id, title: $title, company: $company, description: $description, location: $location, salary: $salary, requirements: $requirements, postedDate: $postedDate, applicantsCount: $applicantsCount, status: $status, hasApplied: $hasApplied)';
}
