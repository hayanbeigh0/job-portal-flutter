...
mixin _$AuthUserDto {
 ...
 String get id; String get phoneNumber; String? get name; bool get isProfileComplete; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,phoneNumber,name,isProfileComplete,createdAt);

@override
String toString() {
  return 'AuthUserDto(id: $id, phoneNumber: $phoneNumber, name: $name, isProfileComplete: $isProfileComplete, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String phoneNumber, String? name, bool isProfileComplete, DateTime createdAt
});
...
/// Create a copy of AuthUserDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? phoneNumber = null,Object? name = freezed,Object? isProfileComplete = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String phoneNumber,  String? name,  bool isProfileComplete,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthUserDto() when $default != null:
return $default(_that.id,_that.phoneNumber,_that.name,_that.isProfileComplete,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String phoneNumber,  String? name,  bool isProfileComplete,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _AuthUserDto():
return $default(_that.id,_that.phoneNumber,_that.name,_that.isProfileComplete,_that.createdAt);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String phoneNumber,  String? name,  bool isProfileComplete,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthUserDto() when $default != null:
return $default(_that.id,_that.phoneNumber,_that.name,_that.isProfileComplete,_that.createdAt);case _:
  return null;
...
class _AuthUserDto extends AuthUserDto {
  const _AuthUserDto({required this.id, required this.phoneNumber, this.name, required this.isProfileComplete, required this.createdAt}): super._();
...
/// Create a copy of AuthUserDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? phoneNumber = null,Object? name = freezed,Object? isProfileComplete = null,Object? createdAt = null,}) {
